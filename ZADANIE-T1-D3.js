...
function zakupy(balansPortfela, towary) {
    ...
    console.log("Mam w portfelu " + balansPortfela + " zł");
    console.log("W sklepie znajdują się następujące towary: ");

    for(let towar of towary)
    {
      console.log(towar.liczbaSztuk + " x " + towar.nazwa + " za " + towar.koszt + " zł za sztukę");
    }
  
    for (const towar of towary) {
                const maxIlosc = Math.floor(balansPortfela / towar.koszt);
                const kupioneSztuki = Math.min(maxIlosc, towar.liczbaSztuk);
                balansPortfela -= kupioneSztuki * towar.koszt;
                koszyk.push({nazwa: towar.nazwa, liczbaSztuk: kupioneSztuki, koszt: towar.koszt, całyKoszt: towar.koszt * kupioneSztuki});
    }
    
    console.log("Koszyk zawiera:");
            for (const towar of koszyk) {
                console.log(towar.nazwa + " x " + towar.liczbaSztuk + " szt = " + towar.całyKoszt + " zł");
                
            }
            console.log("Pozostało w portfelu " + balansPortfela + " zł");
...
*/
podpowiedźPierwsza  ("TAK");    // Mała podpowiedź od czego zacząć.
podpowiedźDruga     ("TAK");    // Większa podpowiedź od czego zacząć.
podpowiedźTrzecia   ("TAK");    // Duża podpowiedź algorytmu.
