...
*/
odpowiedź("A");
uzasadnienie(`typy to sposób klasyfikowania wartości`);
...
*/
odpowiedź("const");
uzasadnienie(`no stała to const co tu więcej tłumaczyć`);
...
*/
odpowiedź("B");
uzasadnienie(`sama nazwa wskazuje na to, że używamy tego do czynności, które się powtarzają`);
...
*/
odpowiedź("1010");
uzasadnienie(`nie dodajemy stringu do numbera`);
...
uzasadnienie(`aby wywolać funkcje piszemy jej nazwę, a parametry wpisujemy w nawiasie`);
...
uzasadnienie(`zaczynamy liczenie od 0`);
...
*/
odpowiedź("infinity");
uzasadnienie(`bo ta petla sie nie konczy`);
